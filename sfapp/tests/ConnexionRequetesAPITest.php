...
class ConnexionRequetesAPITest extends TestCase
{
    public function testGetCaptures()
    {
        ...
        $response = $api->getCaptures("D004");

        $this->assertEquals("GET",$mockResponse->getRequestMethod());
        $this->assertEquals("https://sae34.k8s.iut-larochelle.fr/api/captures",$mockResponse->getRequestUrl());
    ...
    public function testGetIntervalCaptures()
    {
        ...
        $response = $api->getIntervalCaptures('2024-01-09','2024-01-10',"D004");

        $this->assertEquals("GET",$mockResponse->getRequestMethod());
        $this->assertEquals("https://sae34.k8s.iut-larochelle.fr/api/captures/interval?date1=2024-01-09&date2=2024-01-10",$mockResponse->getRequestUrl());
        $this->assertEquals([0=> 'dbname: sae34bdm1eq1', 1=> 'username: m1eq1', 2=> 'userpass: sodqif-vefXym-0cikho', 3=> 'Accept: */*'],$mockResponse->getRequestOptions()['headers']);
        $this->assertEquals(['date1'=>'2024-01-09', 'date2'=>'2024-01-10'],$mockResponse->getRequestOptions()['query']);
    }
    ...
    public function testGetLastCaptures()
    {
        ...
        $response = $api->getlastCaptures(5,"D004");

        $this->assertEquals("GET",$mockResponse->getRequestMethod());
        $this->assertEquals("https://sae34.k8s.iut-larochelle.fr/api/captures/last?limit=5",$mockResponse->getRequestUrl());
        $this->assertEquals([0=> 'dbname: sae34bdm1eq1', 1=> 'username: m1eq1', 2=> 'userpass: sodqif-vefXym-0cikho', 3=> 'Accept: */*'],$mockResponse->getRequestOptions()['headers']);
        $this->assertEquals(['limit'=>5],$mockResponse->getRequestOptions()['query']);
    }
}