 ...
 */
final class Version20240110081638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE intervention (id INT AUTO_INCREMENT NOT NULL, sa_id INT NOT NULL, technicien_id INT DEFAULT NULL, starting_date DATE DEFAULT NULL, ending_date DATE DEFAULT NULL, message VARCHAR(500) DEFAULT NULL, report VARCHAR(500) DEFAULT NULL, type_i VARCHAR(15) NOT NULL check (type_i in (\'INSTALLATION\',\'MAINTENANCE\')), state VARCHAR(8) DEFAULT NULL check (state in (\'EN_COURS\',\'FINIE\',\'ANNULEE\')), INDEX IDX_D11814AB62CAE146 (sa_id), INDEX IDX_D11814AB13457256 (technicien_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
